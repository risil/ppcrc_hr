...
const UploadResume: React.FC = () => {
  ...
  const handleSubmit = (event: React.FormEvent) => {
    ...
    } else if (!isFileSelected && !isTextSelected && isTermsAccepted) {
    ...
    <div className="mt-8 mb-8 flex flex-col items-center justify-center h-screen">
      <div className="p-12 bg-white rounded-lg shadow-2xl w-full md:w-4/5 lg:w-3/5">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex justify-end">
            <button
              className={`px-5 py-2 bg-blue-500 border border-blue-500 text-white font-semibold rounded-2xl ${
